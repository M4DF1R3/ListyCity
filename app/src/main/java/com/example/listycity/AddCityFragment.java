...
public class AddCityFragment extends DialogFragment {
    ...
    private City currentlyEditCity;
    @Override
    ...
    public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
        ...
        // If we are editing currentlyEditCity != null but if we are adding currentlyEditCity = null
        if (currentlyEditCity != null) {
            cityName.setText(currentlyEditCity.getName());
            provinceName.setText(currentlyEditCity.getProvince());
        }
        ...
        return builder
                ...
                .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        if (currentlyEditCity != null) {
                            currentlyEditCity.setName(cityName.getText().toString());
                            currentlyEditCity.setProvince(provinceName.getText().toString());
                        } else {
