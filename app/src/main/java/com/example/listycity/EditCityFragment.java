...
public class EditCityFragment extends DialogFragment {
    ...
    private AddCityFragment.OnFragmentInteractionListener listener;
    @Override
    public void onAttach(@NonNull Context context) {
        super.onAttach(context);
        if (context instanceof AddCityFragment.OnFragmentInteractionListener) {
            listener = (AddCityFragment.OnFragmentInteractionListener) context;
        }
        else {
